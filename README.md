...
- [CSSGen 文档系统开发指南](#cssgen-文档系统开发指南)
  - [📚 目录](#-目录)
  - [文档系统概述](#文档系统概述)
  - [编写文档文件](#编写文档文件)
    - [文件位置和命名](#文件位置和命名)
  ...
  - [添加组件](#添加组件)
    - [注册组件（开发人员）](#注册组件开发人员)
      ...
      - [2. 注册组件](#2-注册组件)
    - [在文档中使用组件](#在文档中使用组件)
      - [1. 在 Front Matter 中配置](#1-在-front-matter-中配置)
      - [2. 在 Markdown 中插入](#2-在-markdown-中插入)
  - [多语言支持](#多语言支持)
    - [语言目录结构](#语言目录结构)
    - [语言配置（开发人员）](#语言配置开发人员)
    - [创建多语言文档](#创建多语言文档)
  - [最佳实践](#最佳实践)
    - [文档编写](#文档编写)
  - [常见问题](#常见问题)
    - [Q: 文档没有显示在导航中？](#q-文档没有显示在导航中)
    - [Q: 组件演示没有显示？](#q-组件演示没有显示)
    - [Q: 如何调整文档顺序？](#q-如何调整文档顺序)
    - [Q: 如何创建文档树结构？](#q-如何创建文档树结构)
    - [Q: 如何添加翻页导航？](#q-如何添加翻页导航)
...
demos:
  - key: demo-key              # 必需：演示的唯一标识符，用于后续插入组件
    title: 演示标题            # 可选：演示标题
    sticky: true               # 可选：是否允许组件浮动并遮挡文字区域
